...
USTRUCT()
struct IMGUI_API FImGuiToolkitStyleSettings
{
	GENERATED_BODY()

public:
	FImGuiToolkitStyleSettings();
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Windows")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Borders")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Frames")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Buttons")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Headers")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Separators")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Resize Grip")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Tabs")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Docking")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Scrollbars")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Tables")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Plots")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Feedback")
	FLinearColor DragDropTarget = FLinearColor::FromSRGBColor(FColor(255, 220, 0, 230));

	UPROPERTY(EditAnywhere, Category = "Colors|Navigation")
	...
	UPROPERTY(EditAnywhere, Category = "Colors|Modals")
	FLinearColor ModalWindowDimBg = FLinearColor::FromSRGBColor(FColor(0, 0, 0, 150));

	UPROPERTY(EditAnywhere, Category = "Colors|Menus")
...
public:
	...
	const FImGuiToolkitStyleSettings& GetStyleSettingsForTarget(EImGuiToolkitStyleTarget StyleTarget) const;
	float GetScaleForTarget(EImGuiToolkitStyleTarget StyleTarget) const;

	UPROPERTY(Config, EditAnywhere, Category = "Runtime")
	FImGuiToolkitStyleSettings RuntimeStyle;

	UPROPERTY(Config, EditAnywhere, Category = "Editor Hosted")
	FImGuiToolkitStyleSettings EditorHostedStyle;
